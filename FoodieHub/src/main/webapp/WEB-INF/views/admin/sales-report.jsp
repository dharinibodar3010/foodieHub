...
<style>
  ...
  .stat-revenue { background: linear-gradient(135deg, rgba(40,167,69,0.1), rgba(40,167,69,0.02)) !important; border: 1px solid rgba(40,167,69,0.15) !important; }
  .stat-revenue::before { background: #28a745; }
  .stat-revenue:hover { border-color: rgba(40,167,69,0.5) !important; box-shadow: 0 15px 35px rgba(40,167,69,0.2) !important; transform: translateY(-8px); }
  ...
  <div style="flex:1;padding:32px;min-height:calc(100vh - 70px);">
    ...
    <div style="position:sticky; top:0; z-index:98; background:rgba(13,13,20,0.85); backdrop-filter:blur(25px); -webkit-backdrop-filter:blur(25px); padding:24px 32px 16px 32px; margin:-32px -32px 24px -32px; border-bottom:1px solid rgba(255,255,255,0.04); box-shadow: 0 10px 40px rgba(0,0,0,0.3);">
      ...
      <form id="customDateForm" action="${pageContext.request.contextPath}/salesReport" method="get" 
            style="display:${currentFilter == 'custom' ? 'flex' : 'none'};gap:16px;align-items:flex-end;margin-bottom:16px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);padding:20px;border-radius:16px;flex-wrap:wrap;">
      ...
      <div class="row g-4">
        <div class="col-md-6">
          <div class="sales-stat-card stat-revenue" style="display:flex;align-items:center;gap:20px;">
            ...
            <div>
              ...
              <div style="font-size:2.2rem;font-weight:900;background:linear-gradient(135deg,#28a745,#20c997);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">
                ₹${totalRevenue}
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6">
          <div class="sales-stat-card stat-orders" style="display:flex;align-items:center;gap:20px;">
            ...
            <div>
              ...
              <div style="font-size:2.2rem;font-weight:900;background:linear-gradient(135deg,#6366f1,#8b5cf6);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">
                ${totalOrders}
              </div>
            </div>
          </div>
    ...
    <div style="background:rgba(18,18,26,0.7);border:1px solid rgba(255,255,255,0.06);border-radius:24px;padding:28px;backdrop-filter:blur(25px);-webkit-backdrop-filter:blur(25px);box-shadow:0 15px 35px rgba(0,0,0,0.4);position:relative;overflow:hidden;">
      <div style="position:absolute;bottom:-50px;right:-50px;width:200px;height:200px;background:rgba(255,94,0,0.08);border-radius:50%;filter:blur(40px);pointer-events:none;"></div>
      <h6 style="font-weight:800;font-size:1.1rem;margin-bottom:20px;position:relative;z-index:2;">Orders (${currentFilter})</h6>

      <div style="overflow-x:auto; overflow-y:auto; max-height:calc(100vh - 350px); padding-right:5px;">
        <table style="width:100%;border-collapse:collapse;">
          <thead style="box-shadow: 0 2px 5px rgba(0,0,0,0.5);">
            <tr>
              <th style="position: sticky; top: 0; background: #151515; z-index: 10; padding:12px 16px;text-align:left;font-size:0.75rem;font-weight:700;text-transform:uppercase;color:rgba(255,255,255,0.9);border-bottom:1px solid rgba(255,255,255,0.1);">Order ID</th>
              <th style="position: sticky; top: 0; background: #151515; z-index: 10; padding:12px 16px;text-align:left;font-size:0.75rem;font-weight:700;text-transform:uppercase;color:rgba(255,255,255,0.9);border-bottom:1px solid rgba(255,255,255,0.1);">Customer</th>
              <th style="position: sticky; top: 0; background: #151515; z-index: 10; padding:12px 16px;text-align:left;font-size:0.75rem;font-weight:700;text-transform:uppercase;color:rgba(255,255,255,0.9);border-bottom:1px solid rgba(255,255,255,0.1);">Date</th>
              <th style="position: sticky; top: 0; background: #151515; z-index: 10; padding:12px 16px;text-align:left;font-size:0.75rem;font-weight:700;text-transform:uppercase;color:rgba(255,255,255,0.9);border-bottom:1px solid rgba(255,255,255,0.1);">Amount</th>
              <th style="position: sticky; top: 0; background: #151515; z-index: 10; padding:12px 16px;text-align:left;font-size:0.75rem;font-weight:700;text-transform:uppercase;color:rgba(255,255,255,0.9);border-bottom:1px solid rgba(255,255,255,0.1);">Status</th>
            </tr>
          </thead>
          <tbody>
